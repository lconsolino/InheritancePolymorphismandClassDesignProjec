...
{
    Product* makingBook= new Book(prodName_, price_, qty_, isbn_, author_);
    return makingBook;
...
{
    Product* makingClothing= new Clothing(prodName_, price_, qty_, brand_,size_);
    return makingClothing;
 ...
 * using the data members in this class and the parent ProductParser class
 */
Product* ProductMovieParser::makeProduct() //where am I storing new Product
{
    Product* makingMovie= new Movie(prodName_, price_, qty_, genre_,rating_);
    return makingMovie;
}
